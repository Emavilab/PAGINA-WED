...
L <?php echo number_format($precio,2); ?>
</td>
...
L <?php echo number_format($precio * $cantidad,2); ?>
</td>
...
<p>
Subtotal: 
<strong>L <?php echo number_format($pedido['subtotal'],2); ?></strong>
</p>

<p>
Impuesto: 
<strong>L <?php echo number_format($pedido['impuesto_total'],2); ?></strong>
</p>
...
<p>
Envío (<?php echo htmlspecialchars($pedido['metodo_envio'] ?? 'Método'); ?>):
