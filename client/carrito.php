...
<!-- ============================================================= -->
<!--
    COMPONENTE: PANEL LATERAL DEL CARRITO DE COMPRAS

    DESCRIPCIÓN:
    Este archivo HTML representa el panel lateral del carrito de compras
    de una tienda en línea. Se muestra como un sidebar que aparece desde
    el lado derecho de la pantalla.

    FUNCIONALIDADES VISUALES:
    ✔ Mostrar productos agregados al carrito
    ✔ Mostrar imagen, nombre, precio y cantidad
    ✔ Permitir aumentar o disminuir cantidad
...
<img alt="Reloj Minimalista"
class="w-full h-full object-cover"
src="https://lh3.googleusercontent.com/aida-public/AB6AXuDyMui6hcPTjNBKyHfNzFAYeygXtkWmyHWn_C4wfn7rFaCjoq0M9SOHWEGdEm3vJS9fCaRyrLFWl8rJPlNYpJo0mMFbNQvNwvC2G_1L-8yDyBNd0hxhpxq8_qejsD0xdiz06FkU-STszocNHnaZYyupjQEbkKeQMKkKYzo6PzT8vcaUNYB2Dm-ZN5SOkaRnBc2hkkASEtDayluznVaXBeb9S_iHpz--Wa-OPMFapelO1RAPkyovvh282UPQfDEP-BAKPx3gJlapjOU"/>
...
<span class="material-symbols-outlined text-xs block">
remove
</span>
</button>
...
Envío gratis aplicado para este pedido 🚚
</p>
